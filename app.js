...
const translations = {
    'zh': {
        splash_title: "瑞芳導覽 App", splash_desc: "致力於提供瑞芳地區最精準的在地導覽，帶領您深度探索山城之美。", lang: "語言 / Language", enter_map: "進入地圖", form_link: "填寫意見問卷",
        tut_step1_title: "功能說明 (1/2)", tut_search: "搜尋與標籤", tut_add: "長按新增", tut_weather: "天氣資訊", tut_next: "下一步",
        tut_step2_title: "快捷功能 (2/2)", tut_settings: "設定", tut_compass: "指北針", tut_share: "分享鍵", tut_prev: "前一步", tut_finish: "開始使用",
        settings: "系統設定", theme: "主題顏色", share_map_title: "推薦給好友", share_map: "分享導覽地圖", close: "關閉", search_ph: "🔍 搜尋景點或長按新增...", locating: "定位中...", 
        food: "在地飲食", highlights: "推薦亮點", history: "簡介歷史", transport: "交通方式", nav: " 導航", ai: " 行程規劃",
        chip_all: "🌟 全部", chip_food: "🍜 美食", chip_history: "🏛️ 歷史", chip_nature: "⛰️ 自然", chip_custom: "📍 標記", contact: "聯絡開發團隊"
    },
    'en': {
        ...
        settings: "Settings", theme: "Theme Color", share_map_title: "Recommend", share_map: "Share Map", close: "Close", search_ph: "🔍 Search or long press...", locating: "Locating...", 
        food: "Food", highlights: "Highlights", history: "History", transport: "Transport", nav: " Navigate", ai: " Plan Trip",
        chip_all: "🌟 All", chip_food: "🍜 Food", chip_history: "🏛️ History", chip_nature: "⛰️ Nature", chip_custom: "📍 Custom", contact: "Contact Team"
    },
    'ja': {
        splash_title: "瑞芳ガイド", splash_desc: "瑞芳の正確なローカルガイド。", lang: "言語", enter_map: "マップへ", form_link: "アンケート",
        tut_step1_title: "機能 (1/2)", tut_search: "検索とタグ", tut_add: "長押しで追加", tut_weather: "天気", tut_next: "次へ",
        tut_step2_title: "ショートカット (2/2)", tut_settings: "設定", tut_compass: "コンパス", tut_share: "共有", tut_prev: "戻る", tut_finish: "始める",
        settings: "設定", theme: "テーマ色", share_map_title: "友達に勧める", share_map: "マップを共有", close: "閉じる", search_ph: "🔍 検索または長押し...", locating: "取得中...", 
        food: "グルメ", highlights: "見どころ", history: "歴史", transport: "アクセス", nav: " ナビ", ai: " ルート",
        chip_all: "🌟 全て", chip_food: "🍜 食事", chip_history: "🏛️ 歴史", chip_nature: "⛰️ 自然", chip_custom: "📍 カスタム", contact: "お問い合わせ"
    },
    'ko': {
        splash_title: "루이팡 가이드", splash_desc: "루이팡 지역의 정확한 로컬 가이드.", lang: "언어 / Language", enter_map: "지도 입장", form_link: "설문조사",
        tut_step1_title: "기능 (1/2)", tut_search: "검색 및 태그", tut_add: "길게 눌러 추가", tut_weather: "날씨", tut_next: "다음",
        tut_step2_title: "단축키 (2/2)", tut_settings: "설정", tut_compass: "나침반", tut_share: "공유", tut_prev: "이전", tut_finish: "시작하기",
        settings: "설정", theme: "테마 색상", share_map_title: "친구에게 추천", share_map: "지도 공유", close: "닫기", search_ph: "🔍 검색 또는 길게 누르기...", locating: "위치 확인 중...", 
        food: "음식", highlights: "하이라이트", history: "역사", transport: "교통", nav: " 내비게이션", ai: " 추천",
        chip_all: "🌟 전체", chip_food: "🍜 음식", chip_history: "🏛️ 역사", chip_nature: "⛰️ 자연", chip_custom: "📍 마커", contact: "개발팀에 문의"
    },
    'vi': {
        splash_title: "Bản đồ Ruifang", splash_desc: "Hướng dẫn du lịch địa phương chính xác nhất.", lang: "Ngôn ngữ", enter_map: "Vào Bản Đồ", form_link: "Bảng câu hỏi",
        tut_step1_title: "Chức năng (1/2)", tut_search: "Tìm kiếm", tut_add: "Nhấn giữ thêm", tut_weather: "Thời tiết", tut_next: "Tiếp",
        tut_step2_title: "Phím tắt (2/2)", tut_settings: "Cài đặt", tut_compass: "La bàn", tut_share: "Chia sẻ", tut_prev: "Trước", tut_finish: "Bắt đầu",
        settings: "Cài đặt", theme: "Màu chủ đề", share_map_title: "Giới thiệu cho bạn bè", share_map: "Chia sẻ Bản đồ", close: "Đóng", search_ph: "🔍 Tìm kiếm...", locating: "Đang định vị...", 
        food: "Ẩm thực", highlights: "Nổi bật", history: "Lịch sử", transport: "Di chuyển", nav: " Chỉ đường", ai: " Hành trình",
        chip_all: "🌟 Tất cả", chip_food: "🍜 Ăn", chip_history: "🏛️ Lịch sử", chip_nature: "⛰️ Tự nhiên", chip_custom: "📍 Đã lưu", contact: "Liên hệ"
    }
};
...
const firebaseConfig = {
    apiKey: "請至Firebase後台取得 Web API Key", 
...
function saveEditSpot() {
    ...
    if(s.markerObj) cluster.removeLayer(s.markerObj);
    addMarkerToMap(s);
...
function goToStation() { 
    ...
    if(ruiIcon){ 
        ruiIcon.classList.remove('stamped'); 
        void ruiIcon.offsetWidth; 
        ruiIcon.classList.add('stamped'); 
    } 
    map.flyTo([25.108, 121.805], 16); 
    closeCard(); 
} 
